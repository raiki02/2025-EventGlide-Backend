...
type Activity struct {
	...
	LikeNum    uint `gorm:"type:uint;column:like_num;default:0"`
	CollectNum uint `gorm:"type:uint;column:collect_num;default:0"`
	CommentNum uint `gorm:"type:uint;column:comment_num;default:0"`
}
